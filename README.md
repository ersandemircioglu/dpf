...
- **Docker**: is used to containerize the modules and also the processing applications. In a final system, Kubernetes would be a better option for container management, but in this prototype, Docker's Java API is used also for container management.    
